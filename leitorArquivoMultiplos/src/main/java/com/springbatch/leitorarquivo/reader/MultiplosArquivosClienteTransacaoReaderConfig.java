...
public class MultiplosArquivosClienteTransacaoReaderConfig {
    ...
    public MultiResourceItemReader MultiplosArquivosClienteTransacaoReaderConfig(@Value("#{jobParameters['arquivosClientes']}") Resource[] arquivosClientes, FlatFileItemReader leituraArquivoMultiplosFormatosReader) {
