-- Para gerar erros no BD, foi utilizado a query:
-- update app.cliente set faixa_salarial = null where faixa_salarial >= 100000 (linhas 229);
-- Removido linhas de DROP TABLE para que os erros com null ocorram de fato
...
-- DROP TABLE IF EXISTS app.conta;

CREATE TABLE IF NOT EXISTS app.conta
(
...
INSERT IGNORE INTO app.cliente (nome, idade, email, faixa_salarial)
